...
exports.isRequiredIf = exports.allPropTypes = exports.extractShapesArray = exports.deprecateProp = exports.deprecatePropUsage = exports.prepareProps = void 0;
...
var deprecatePropInner = function deprecatePropInner(message, validator, info) {
  return function () {
    ...
    args[0][args[1]] && _pconsole.default.warn(message(args[3], args[4] || args[1], args[2], info));
...
var deprecatePropUsage = deprecatePropInner.bind(undefined, function (location, propName, componentName, info) {
...
var deprecateProp = deprecatePropInner.bind(undefined, function (location, propName, componentName, info) {
...
var extractShapesArray = function extractShapesArray(items) {
  ...
  if (items && (items !== null && items !== void 0 && (_items$ = items[0]) !== null && _items$ !== void 0 && _items$.props || (items === null || items === void 0 ? void 0 : (_items$2 = items[0]) === null || _items$2 === void 0 ? void 0 : _items$2.type) === _react.default.Fragment || items.type === _react.default.Fragment)) {
    return (0, _unwrapIfFragment.default)(items).map(function (item) {
