...
exports.NoDataEmptyState = NoDataEmptyState = _settings.pkg.checkComponentEnabled(NoDataEmptyState, componentName); // The display name of the component, used by React. Note that displayName
// is used in preference to relying on function.name.

NoDataEmptyState.displayName = componentName; // The types and DocGen commentary for the component props,
