...
var UnauthorizedEmptyState = /*#__PURE__*/_react.default.forwardRef(function (_ref, ref) {
  ...
  rest, {
    ...
    ref: ref
  }), /*#__PURE__*/_react.default.createElement(_UnauthorizedIllustration.UnauthorizedIllustration, {
    size: size,
...
exports.UnauthorizedEmptyState = UnauthorizedEmptyState = _settings.pkg.checkComponentEnabled(UnauthorizedEmptyState, componentName); // The display name of the component, used by React. Note that displayName
// is used in preference to relying on function.name.

UnauthorizedEmptyState.displayName = componentName; // The types and DocGen commentary for the component props,
