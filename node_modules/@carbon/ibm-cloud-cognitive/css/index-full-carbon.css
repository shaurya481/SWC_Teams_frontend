...
.bx--snippet--multi .bx--snippet-container pre::after {
  ...
  width: 1rem;
  height: 100%;
  background-image: linear-gradient(to right, rgba(var(--cds-field, #f4f4f4), 0), var(--cds-field, #f4f4f4));
  content: "";
}
...
.bx--snippet-button:hover {
  background: var(--cds-field-hover, #e5e5e5);
}
...
.bx--snippet__overflow-indicator--left {
  order: 0;
  margin-right: -1rem;
  background-image: linear-gradient(to left, transparent, var(--cds-field, #f4f4f4));
}

.bx--snippet__overflow-indicator--right {
  order: 2;
  margin-left: -1rem;
  background-image: linear-gradient(to right, transparent, var(--cds-field, #f4f4f4));
}
...
@media not all and (min-resolution: 0.001dpcm) {
  @supports (-webkit-appearance: none) and (stroke-color: transparent) {
    .bx--snippet__overflow-indicator--left {
      background-image: linear-gradient(to left, rgba(var(--cds-field, #f4f4f4), 0), var(--cds-field, #f4f4f4));
    }
...
.bx--btn--ghost:active {
  background-color: var(--cds-background-active, #c6c6c6);
}
...
.bx--tooltip__trigger.bx--btn--icon-only--top::before {
  ...
  border-color: var(--cds-background-inverse, #393939) transparent transparent transparent;
  transform: translate(-50%, -100%);
}
.bx--tooltip__trigger.bx--btn--icon-only--top::after,
.bx--tooltip__trigger.bx--btn--icon-only--top .bx--assistive-text,
...
.bx--tooltip__trigger.bx--btn--icon-only--right::before {
  ...
  border-color: transparent var(--cds-background-inverse, #393939) transparent transparent;
...
.bx--tooltip__trigger.bx--btn--icon-only--left::before {
  ...
  border-color: transparent transparent transparent var(--cds-background-inverse, #393939);
  transform: translate(-100%, -50%);
}
.bx--tooltip__trigger.bx--btn--icon-only--left::after,
.bx--tooltip__trigger.bx--btn--icon-only--left .bx--assistive-text,
...
.bx--modal-content--overflow-indicator {
  ...
  width: 100%;
  height: 2rem;
  background-image: linear-gradient(to bottom, transparent, var(--cds-layer, #f4f4f4));
  content: "";
  grid-column: 1/-1;
  grid-row: 2/-2;
  pointer-events: none;
...
.bx--loading__background {
  stroke: var(--cds-layer-accent, #e0e0e0);
...
.bx--toggle:active + .bx--toggle__label .bx--toggle__appearance::before {
  box-shadow: 0 0 0 1px var(--cds-layer-accent, #e0e0e0), 0 0 0 3px var(--cds-focus, #0f62fe);
}
...
.bx--toggle-input--small:disabled:checked + .bx--toggle-input__label .bx--toggle__check {
  fill: var(--cds-layer-disabled, #f4f4f4);
}
...
@media (min-width: 42rem) {
  ...
  .bx--tabs--container .bx--tabs__nav-item + .bx--tabs__nav-item {
    margin-left: 0;
    box-shadow: -1px 0 0 0 var(--cds-border-strong, #8d8d8d);
  }
...
.bx--tabs__nav-item:hover:not(.bx--tabs__nav-item--disabled) {
  background-color: var(--cds-layer-hover, #e5e5e5);
  box-shadow: 0 -1px 0 var(--cds-layer-hover, #e5e5e5);
}
@media (min-width: 42rem) {
  .bx--tabs__nav-item:hover:not(.bx--tabs__nav-item--disabled) {
    background-color: transparent;
...
.bx--tabs__nav-item--disabled .bx--tabs__nav-link {
  border-bottom: 2px solid var(--cds-border-disabled, #f4f4f4);
  color: var(--cds-text-disabled, #c6c6c6);
  pointer-events: none;
}
...
.bx--tabs--scrollable .bx--tabs__overflow-indicator--left {
  margin-right: -0.5rem;
  background-image: linear-gradient(to left, transparent, var(--cds-background, #ffffff));
}
.bx--tabs--scrollable .bx--tabs__overflow-indicator--right {
  margin-left: -0.5rem;
  background-image: linear-gradient(to right, transparent, var(--cds-background, #ffffff));
}
.bx--tabs--scrollable .bx--tabs--scrollable--light .bx--tabs__overflow-indicator--left {
  background-image: linear-gradient(to left, transparent, var(--cds-layer, #f4f4f4));
}
.bx--tabs--scrollable .bx--tabs--scrollable--light .bx--tabs__overflow-indicator--right {
  background-image: linear-gradient(to right, transparent, var(--cds-layer, #f4f4f4));
}
.bx--tabs--scrollable.bx--tabs--scrollable--container .bx--tabs__overflow-indicator--left {
  background-image: linear-gradient(to left, transparent, var(--cds-layer-accent, #e0e0e0));
}
.bx--tabs--scrollable.bx--tabs--scrollable--container .bx--tabs__overflow-indicator--right {
  background-image: linear-gradient(to right, transparent, var(--cds-layer-accent, #e0e0e0));
}
@media not all and (min-resolution: 0.001dpcm) {
  @supports (-webkit-appearance: none) and (stroke-color: transparent) {
    .bx--tabs--scrollable .bx--tabs__overflow-indicator--left {
    ...
    .bx--tabs--scrollable.bx--tabs--scrollable--container .bx--tabs__overflow-indicator--left {
      background-image: linear-gradient(to left, rgba(var(--cds-layer-accent, #e0e0e0), 0), var(--cds-layer-accent, #e0e0e0));
    }
    .bx--tabs--scrollable.bx--tabs--scrollable--container .bx--tabs__overflow-indicator--right {
      background-image: linear-gradient(to right, rgba(var(--cds-layer-accent, #e0e0e0), 0), var(--cds-layer-accent, #e0e0e0));
    }
  }
}
...
.bx--tabs--scrollable.bx--tabs--scrollable--container .bx--tabs--scrollable__nav-item + .bx--tabs--scrollable__nav-item {
  margin-left: 0;
  box-shadow: -0.0625rem 0 0 0 var(--cds-border-strong, #8d8d8d);
}
...
.exp--create-full-page .exp--create-full-page__step-text-content,
.exp--create-full-page .exp--create-full-page__section-text-content {
...
.exp--create-full-page .exp--create-full-page__section-divider {
  ...
  height: 1px;
  margin: var(--cds-spacing-05, 1rem) calc(-1 * var(--cds-spacing-08, 2.5rem)) var(--cds-spacing-08, 2.5rem) calc(-1 * var(--cds-spacing-08, 2.5rem));
...
.exp--create-full-page .exp--create-full-page__step-form > *,
.exp--create-full-page .exp--create-full-page__section-form > * {
  margin-bottom: var(--cds-spacing-06, 1.5rem);
}
...
.exp--create-full-page .exp--create-full-page__progress-indicator {
  min-height: calc(100% - var(--cds-spacing-10, 4rem));
}
...
.exp--create-side-panel.exp--side-panel__container .exp--side-panel__title-text {
  padding-right: calc(20% - var(--cds-spacing-05, 1rem));
  margin-bottom: var(--cds-spacing-02, 0.25rem);
}

.exp--create-side-panel.exp--side-panel__container .exp--side-panel__subtitle-text {
  padding-right: calc(20% - var(--cds-spacing-05, 1rem));
  padding-bottom: var(--cds-spacing-05, 1rem);
  border-bottom: 1px solid var(--cds-ui-03, #e0e0e0);
  color: var(--cds-text-02, #525252);
...
.exp--create-side-panel__form > *:last-child {
  margin-bottom: 0;
}
...
.bx--tooltip__trigger:not(.bx--btn--icon-only):focus {
  outline: 1px solid var(--cds-focus, #0f62fe);
  fill: var(--cds-button-primary-hover, #0353e9);
}
@media screen and (prefers-contrast) {
  .bx--tooltip__trigger:not(.bx--btn--icon-only):focus {
    outline-style: dotted;
...
.bx--tooltip:focus {
  box-shadow: inset 0 0 0 1px var(--cds-background-inverse, #393939), inset 0 0 0 2px var(--cds-background, #ffffff);
  outline: 0;
}
...
.bx--tooltip .bx--btn:focus {
  ...
  outline-color: var(--cds-background-inverse, #393939);
}
.bx--tooltip .bx--link {
...
.bx--tooltip .bx--tooltip__caret {
  ...
  border-bottom: 0.4296875rem solid var(--cds-background-inverse, #393939);
...
.bx--tooltip__trigger.bx--tooltip__trigger--definition {
  ...
  line-height: var(--cds-label-01-line-height, 1.34);
  letter-spacing: var(--cds-label-01-letter-spacing, 0.32px);
  border-bottom: 0.0625rem dotted var(--cds-icon-secondary, #525252);
...
.bx--progress-label:active {
  box-shadow: 0 0.1875rem 0 0 var(--cds-background-brand, #0f62fe);
...
.bx--progress-step--disabled svg {
  cursor: not-allowed;
  fill: var(--cds-text-disabled, #c6c6c6);
}
...
.exp--tearsheet-create .exp--tearsheet-create__step--visible-step:not(.exp--tearsheet-create__step--first-panel-step) {
...
.exp--tearsheet-create .exp--tearsheet-create__multi-step-panel-content {
  padding: var(--cds-spacing-06, 1.5rem) var(--cds-spacing-07, 2rem);
}

.exp--tearsheet-create .exp--tearsheet__influencer {
  display: grid;
  grid-template-columns: 100%;
  grid-template-rows: 1fr auto;
}

.exp--tearsheet-create .exp--tearsheet-create__left-nav {
  grid-column: 1/-1;
  grid-row: 1/-1;
  overflow-y: auto;
}

.exp--tearsheet-create .exp--tearsheet-create__progress-indicator {
...
.exp--tearsheet-create .exp--tearsheet-create__step {
  max-width: 50%;
}
...
.exp--tearsheet-create .exp--tearsheet-create__view-all-toggle {
  padding: var(--cds-spacing-05, 1rem);
  grid-column: 1/-1;
  grid-row: -1/-1;
}
...
.bx--radio-button:disabled:checked + .bx--radio-button__label .bx--radio-button__appearance {
  border-color: var(--cds-text-disabled, #c6c6c6);
}
...
.bx--radio-button:disabled:checked + .bx--radio-button__label .bx--radio-button__appearance::before {
  background-color: var(--cds-text-disabled, #c6c6c6);
}
...
.exp--export-modal .bx--modal-content {
  padding-right: var(--cds-spacing-05, 1rem);
}
...
.exp--import-modal__import-button {
...
.exp--action-bar .exp--action-bar__overflow-menu {
  display: inline-block;
}

.exp--action-bar-options .exp--action-bar__overflow-menu-item {
  padding: 0 var(--cds-spacing-03, 0.5rem);
}
.exp--action-bar-options .exp--action-bar__overflow-menu-item-content {
  display: flex;
  width: 100%;
  justify-content: space-between;
}
.exp--action-bar-options .exp--action-bar__overflow-menu-item svg {
...
.bx--search-button:active {
  outline: 2px solid var(--cds-focus, #0f62fe);
  outline-offset: -2px;
  background-color: var(--cds-background-selected, #e0e0e0);
}
@media screen and (prefers-contrast) {
  .bx--search-close:active,
.bx--search-button:active {
...
.bx--tag--high-contrast .bx--tag__close-icon:hover {
  background-color: var(--cds-background-inverse-hover, #4c4c4c);
}
...
.bx--tag.bx--skeleton {
  ...
  box-shadow: none;
  pointer-events: none;
  background-color: var(--cds-skeleton-background, #e5e5e5);
  color: var(--cds-text-primary, #161616);
  overflow: hidden;
  width: 3.75rem;
}
...
.exp--tag-set .exp--tag-set__space--right {
  text-align: end;
}
...
.bx--breadcrumb-menu-options.bx--overflow-menu-options::after {
  ...
  border-bottom: 0.4375rem solid var(--cds-field, #f4f4f4);
...
.exp--breadcrumb-with-overflow .exp--breadcrumb-with-overflow--breadcrumb-back-button.bx--btn.bx--btn--icon-only.bx--tooltip__trigger {
  display: inline-flex;
...
.exp--page-header .exp--page-header__page-actions {
  flex: 0 0 100%;
  margin-top: var(--cds-spacing-05, 1rem);
  margin-bottom: calc(-1 * var(--cds-spacing-02, 0.25rem));
  white-space: nowrap;
}
@media (min-width: 42rem) {
  .exp--page-header .exp--page-header__page-actions {
...
.exp--side-panel__container .exp--side-panel__subtitle-text {
  ...
  letter-spacing: var(--cds-body-short-01-letter-spacing, 0.16px);
  overflow: hidden;
  padding: 0 var(--cds-spacing-05, 1rem) var(--cds-spacing-05, 1rem) var(--cds-spacing-05, 1rem);
  -webkit-box-orient: vertical;
  -webkit-line-clamp: 3;
  opacity: var(--exp--side-panel--subtitle-opacity);
}
.exp--side-panel__container .exp--side-panel__subtitle-text.exp--side-panel__subtitle-text-no-animation {
  ...
  position: fixed;
  z-index: 2;
  top: calc( var(--exp--side-panel--title-container-height) + var(--cds-spacing-09, 3rem) );
  background-color: var(--cds-ui-01, #f4f4f4);
}
...
.exp--side-panel__container .exp--side-panel__title-container.exp--side-panel__title-container--no-animation {
  min-width: 30rem;
  max-width: 30rem;
  position: fixed;
  top: var(--cds-spacing-09, 3rem);
  height: var(--exp--side-panel--title-container-height);
}
.exp--side-panel__container .exp--side-panel__subtitle-text.exp--side-panel__subtitle-text-no-animation.exp--side-panel__subtitle-text-no-animation-no-action-toolbar + .exp--side-panel__body-content {
  margin-top: calc( var(--exp--side-panel--title-container-height) + var(--exp--side-panel--subtitle-container-height) + var(--cds-spacing-05, 1rem) );
}
.exp--side-panel__container .exp--side-panel__action-toolbar.exp--side-panel__action-toolbar-no-animation {
  min-width: 30rem;
  max-width: 30rem;
  position: fixed;
  top: calc( var(--exp--side-panel--title-container-height) + var(--exp--side-panel--subtitle-container-height) + var(--cds-spacing-09, 3rem) );
  width: 100%;
...
.exp--side-panel__container .exp--side-panel__body-content {
  padding: var(--cds-spacing-05, 1rem);
  padding-top: 0;
  padding-bottom: var(--exp--side-panel--content-bottom-padding);
}
...
.exp--side-panel__container .exp--side-panel__actions-container.exp--action-set--sm {
  min-width: 20rem;
  max-width: 20rem;
}
.exp--side-panel__container .exp--side-panel__actions-container.exp--action-set--md {
  min-width: 30rem;
  max-width: 30rem;
}
.exp--side-panel__container .exp--side-panel__actions-container.exp--action-set--lg {
  min-width: 40rem;
  max-width: 40rem;
}
...
.exp--tearsheet.exp--tearsheet .exp--tearsheet__container {
  transition: transform 240ms cubic-bezier(0, 0, 0.3, 1), max-height 240ms linear;
}
...
.exp--tearsheet.exp--tearsheet--stacked-2-of-2 .exp--tearsheet__container--lower,
.exp--tearsheet.exp--tearsheet--stacked-2-of-3 .exp--tearsheet__container--lower {
  max-height: calc(100% - (var(--cds-spacing-09, 3rem) + var(--cds-spacing-08, 2.5rem) + var(--cds-spacing-05, 1rem)));
}

.exp--tearsheet.exp--tearsheet--stacked-3-of-3 .exp--tearsheet__container--lower {
...
.exp--tearsheet.exp--tearsheet--stacked-1-of-2.is-visible .exp--tearsheet__container,
.exp--tearsheet.exp--tearsheet--stacked-2-of-3.is-visible .exp--tearsheet__container {
...
.exp--tearsheet.exp--tearsheet--wide .bx--modal-header__heading {
  font-size: var(--cds-productive-heading-04-font-size, 1.75rem);
  font-weight: var(--cds-productive-heading-04-font-weight, 400);
  line-height: var(--cds-productive-heading-04-line-height, 1.29);
  letter-spacing: var(--cds-productive-heading-04-letter-spacing, 0);
...
.exp--tearsheet__resize-detector {
  width: 100%;
  height: 0;
}
...
.exp-web-terminal__bar-icon-container:hover .exp-web-terminal__bar-icon-dropdown,
.exp-web-terminal__bar-icon-container:focus .exp-web-terminal__bar-icon-dropdown {
  opacity: 1;
  transform: translateY(0);
  visibility: visible;
}
...
.bx--accordion__item--disabled + .bx--accordion__item {
  border-top: 1px solid var(--cds-border-disabled, #f4f4f4);
}

li.bx--accordion__item--disabled:last-of-type {
  border-bottom: 1px solid var(--cds-border-disabled, #f4f4f4);
}
...
.bx--checkbox-label[data-contained-checkbox-disabled=true]::before {
  border-color: var(--cds-icon-disabled, #c6c6c6);
}
...
.bx--checkbox-label[data-contained-checkbox-state=mixed][data-contained-checkbox-disabled=true]::before {
  background-color: var(--cds-icon-disabled, #c6c6c6);
}
...
.bx--list-box--disabled .bx--list-box__selection--multi {
  background-color: var(--cds-text-disabled, #c6c6c6);
  color: var(--cds-field-disabled, #f4f4f4);
}
...
.bx--list-box__menu-item--active {
  border-bottom-color: var(--cds-layer-selected, #e0e0e0);
  background-color: var(--cds-layer-selected, #e0e0e0);
  color: var(--cds-text-primary, #161616);
}
...
.bx--data-table--zebra tbody tr:not(.bx--parent-row):nth-child(even) td {
  border-top: 1px solid var(--cds-layer-accent, #e0e0e0);
  border-bottom: 1px solid var(--cds-layer-accent, #e0e0e0);
  background-color: var(--cds-layer-accent, #e0e0e0);
}
...
.bx--data-table--zebra tbody tr:nth-child(even).bx--data-table--selected:hover td {
  border-bottom: 1px solid var(--cds-layer-selected-hover, #cacaca);
}
...
.bx--date-picker__input {
  ...
  line-height: var(--cds-code-02-line-height, 1.43);
...
.bx--number input[type=number] {
  ...
  padding-left: 1rem;
  border: 0;
  border-bottom: 0.0625rem solid var(--cds-border-strong, #8d8d8d);
  -moz-appearance: textfield;
  background-color: var(--cds-field, #f4f4f4);
  border-radius: 0;
  color: var(--cds-text-primary, #161616);
...
.bx--select-input:disabled, .bx--select-input:hover:disabled {
  border-bottom-color: var(--cds-border-disabled, #f4f4f4);
  background-color: var(--cds-field-disabled, #f4f4f4);
  color: var(--cds-text-disabled, #c6c6c6);
  cursor: not-allowed;
}
...
.bx--pagination .bx--select-input:hover {
  background: var(--cds-background-hover, #e5e5e5);
}
...
.bx--pagination .bx--select__item-count .bx--select-input {
  border-right: 0.0625rem solid var(--cds-border-subtle, #e0e0e0);
}
...
.bx--slider__thumb:focus {
  background-color: var(--cds-interactive, #0f62fe);
  box-shadow: inset 0 0 0 2px var(--cds-interactive, #0f62fe), inset 0 0 0 3px var(--cds-layer, #f4f4f4);
  transform: translate(-50%, -50%) scale(1.4286);
}
...
.bx--structured-list-row.bx--structured-list-row--header-row {
  border-bottom: 1px solid var(--cds-background-selected, #e0e0e0);
  cursor: inherit;
}
...
.bx--header__menu-item--current::after {
  ...
  left: 0;
  width: 100%;
  border-bottom: 3px solid var(--cds-support-info-inverse, #4589ff);
  content: "";
}
...
.bx--popover--top.bx--popover::before,
.bx--popover--top-left.bx--popover::before,
.bx--popover--top-right.bx--popover::before {
  top: 0;
  right: 0;
  left: 0;
...
.bx--popover--bottom.bx--popover::before,
.bx--popover--bottom-left.bx--popover::before,
.bx--popover--bottom-right.bx--popover::before {
  right: 0;
  bottom: 0;
  left: 0;
  height: var(--cds-popover-offset);
...
.bx--popover--left.bx--popover::before,
.bx--popover--left-top.bx--popover::before,
.bx--popover--left-bottom.bx--popover::before {
  top: 0;
  bottom: 0;
  left: 0;
...
.bx--popover--right.bx--popover::before,
.bx--popover--right-top.bx--popover::before,
.bx--popover--right-bottom.bx--popover::before {
  top: 0;
  right: 0;
  bottom: 0;
  width: var(--cds-popover-offset);
