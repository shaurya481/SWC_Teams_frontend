...
export var UserProfileImage = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var renderUserProfileImage = function renderUserProfileImage() {
    ...
    }), /*#__PURE__*/React.createElement(FillItem, null));
  };
...
UserProfileImage.validateImageDescription = function () {
  return function (_ref2) {
    var image = _ref2.image,
        imageDescription = _ref2.imageDescription;

    if (image && !imageDescription) {
      throw new Error("".concat(componentName, ": imageDescription is missing, this is required when using the image prop"));
    }
  };
};
...
UserProfileImage.propTypes = {
   ...
   */
  imageDescription: allPropTypes([UserProfileImage.validateImageDescription(), PropTypes.string]),
