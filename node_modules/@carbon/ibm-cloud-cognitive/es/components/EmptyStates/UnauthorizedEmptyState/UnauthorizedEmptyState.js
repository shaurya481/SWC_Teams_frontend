...
export var UnauthorizedEmptyState = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  rest, {
    ...
    ref: ref
  }), /*#__PURE__*/React.createElement(UnauthorizedIllustration, {
    size: size,
...
UnauthorizedEmptyState = pkg.checkComponentEnabled(UnauthorizedEmptyState, componentName); // The display name of the component, used by React. Note that displayName
