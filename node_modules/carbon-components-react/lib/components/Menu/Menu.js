...
var Menu = function Menu(_ref) {
  ...
  function getTargetBoundaries() {
    ...
    if (!isRootMenu) {
      ...
      var _getParentMenu$getBou = (_getParentMenu = (0, _utils.getParentMenu)(rootRef === null || rootRef === void 0 ? void 0 : (_rootRef$current = rootRef.current) === null || _rootRef$current === void 0 ? void 0 : _rootRef$current.element)) === null || _getParentMenu === void 0 ? void 0 : _getParentMenu.getBoundingClientRect(),
  ...
  function focusNode(node) {
    if (node) {
      ...
      (0, _utils.resetFocus)(rootRef === null || rootRef === void 0 ? void 0 : (_rootRef$current2 = rootRef.current) === null || _rootRef$current2 === void 0 ? void 0 : _rootRef$current2.element);
  ...
  function handleClickOutside(e) {
    if (!(0, _utils.clickedElementHasSubnodes)(e) && open && canBeClosed && autoclose) {
      onClose();
    }
  }
  ...
  var classes = (0, _classnames2.default)("".concat(prefix, "--menu"), (_classnames = {}, _defineProperty(_classnames, "".concat(prefix, "--menu--open"), open), _defineProperty(_classnames, "".concat(prefix, "--menu--invisible"), open && position[0] === 0 && position[1] === 0), _defineProperty(_classnames, "".concat(prefix, "--menu--root"), isRootMenu), _classnames));
  var ulAttributes = {
    className: classes,
