...
function Popover(_ref) {
  ...
  var className = cx((_cx = {}, _defineProperty(_cx, "".concat(prefix, "--popover"), true), _defineProperty(_cx, "".concat(prefix, "--popover--caret"), caret), _defineProperty(_cx, "".concat(prefix, "--popover--light"), light), _defineProperty(_cx, "".concat(prefix, "--popover--high-contrast"), highContrast), _defineProperty(_cx, "".concat(prefix, "--popover--").concat(align), true), _defineProperty(_cx, "".concat(prefix, "--popover--open"), open), _defineProperty(_cx, "".concat(prefix, "--popover--relative"), relative), _defineProperty(_cx, customClassName, !!customClassName), _cx));
...
var PopoverContent = /*#__PURE__*/React.forwardRef(function PopoverContent(_ref2, ref) {
  ...
  return /*#__PURE__*/React.createElement(BaseComponent, _extends({}, rest, {
    className: cx("".concat(prefix, "--popover-contents"), className),
    ref: ref
  }), children);
});
