...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gwku6t2n8si">Show
  modal</button>

<div data-modal id="modal-gwku6t2n8si" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gwku6t2n8si-label" aria-describedby="modal-gwku6t2n8si-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gwku6t2n8si-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gwku6t2n8si-heading">Modal heading</p>
