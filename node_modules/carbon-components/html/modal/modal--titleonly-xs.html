...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-sfaom4tius">Show
  modal</button>

<div data-modal id="modal-sfaom4tius" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-sfaom4tius-label" aria-describedby="modal-sfaom4tius-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sfaom4tius-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sfaom4tius-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
