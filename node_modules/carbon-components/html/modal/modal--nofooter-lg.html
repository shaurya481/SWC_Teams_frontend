...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ue95k0vcr3">Show
  modal</button>

<div data-modal id="modal-ue95k0vcr3" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ue95k0vcr3-label" aria-describedby="modal-ue95k0vcr3-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ue95k0vcr3-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ue95k0vcr3-heading">Modal heading</p>
