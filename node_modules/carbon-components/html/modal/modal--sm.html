...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bqrphrm06lk">Show
  modal</button>

<div data-modal id="modal-bqrphrm06lk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bqrphrm06lk-label" aria-describedby="modal-bqrphrm06lk-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bqrphrm06lk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bqrphrm06lk-heading">Modal heading</p>
