...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-9sa05m2lu0i">Show
  modal</button>

<div data-modal id="modal-9sa05m2lu0i" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-9sa05m2lu0i-label" aria-describedby="modal-9sa05m2lu0i-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-9sa05m2lu0i-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-9sa05m2lu0i-heading">Modal heading</p>
