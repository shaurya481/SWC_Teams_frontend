...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-pzp9wg2fa1e">Show
  modal</button>

<div data-modal id="modal-pzp9wg2fa1e" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-pzp9wg2fa1e-label" aria-describedby="modal-pzp9wg2fa1e-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pzp9wg2fa1e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pzp9wg2fa1e-heading">Modal heading</p>
