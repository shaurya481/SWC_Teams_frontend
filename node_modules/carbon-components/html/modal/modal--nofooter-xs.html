...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-n4wogwj7co">Show
  modal</button>

<div data-modal id="modal-n4wogwj7co" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-n4wogwj7co-label" aria-describedby="modal-n4wogwj7co-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-n4wogwj7co-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-n4wogwj7co-heading">Modal heading</p>
