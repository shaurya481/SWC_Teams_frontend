...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cthf8r4pm2g">Show
  modal</button>

<div data-modal id="modal-cthf8r4pm2g" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cthf8r4pm2g-label" aria-describedby="modal-cthf8r4pm2g-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cthf8r4pm2g-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cthf8r4pm2g-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
